...
def test__all_subclasses_of_SpiffworkflowBaseDBModel_returns_all_subclasses_that_are_defined() -> None:
    """Test_is_jsonable_can_succeed."""
    FlaskBpmnGroupModel
    assert SpiffworkflowBaseDBModel._all_subclasses() == [FlaskBpmnGroupModel, AppGroupModel]
