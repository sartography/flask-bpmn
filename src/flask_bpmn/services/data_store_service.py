...
#         query = db.session.query(DataStoreModel).filter(DataStoreModel.key == key)
#         if study_id:
...
#         record = (
#             db.session.query(DataStoreModel)
...
#
#     @staticmethod
#     def get_multi_common(
#         study_id: (str | None), user_id: (str | None), file_id: (str | None) = None
#     ):
#         """Get_multi_common."""
...
#         """Delete_data_store."""
#         query = db.session.query(DataStoreModel).filter(DataStoreModel.key == args[0])
#         if user_id:
#             query = query.filter(DataStoreModel.user_id == user_id)
#         elif file_id:
#             query = query.filter(DataStoreModel.file_id == file_id)
